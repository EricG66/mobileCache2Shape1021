...
namespace mobileCache2Shape10
{
    public partial class Form1 : Form
    {
        ...
        private void WriteFeatureDataTable2shp(GeometryType gtype, FeatureDataTable ftable, IFeatureClass fc, String shapefilePath)
        {
            ...
            /// EricG
            /// 
            //IList<ESRI.ArcGIS.Mobile.FeatureCaching.Attachment> AttachmentsList = ftable.FeatureSource.AttachmentManager.GetAttachments(null, EditState.Added) as IList<ESRI.ArcGIS.Mobile.FeatureCaching.Attachment>;
            ...
            for (int i = 0; i < rowCount; i++)
            {
                ...
                else if (arow.Table.Columns.Contains("OBJECTID"))
                {
                    globalid = arow["OBJECTID"].ToString();
                }
                else
                {
                    globalid = arow["FID"].ToString();
                }
